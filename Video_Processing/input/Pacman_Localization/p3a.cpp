...
int main(int argc, char* argv[]) {
	...
	VideoCapture input_cap("input3a2.avi");
	...
	VideoWriter output_cap("output3a2.avi", 
	...
	while(1){
	    ...
	    */
        ...
        int update_dots = trackFilteredObject(frame_threshold, pts);
        
        for(int i = 0; i<pts.size(); i++){
		    circle( frame,pts[i], 1.0, Scalar( 0, 255, 255 ), 1);
	    }
