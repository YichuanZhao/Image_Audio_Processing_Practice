...
int main(int argc, char* argv[]) {
	...
	VideoCapture input_cap("input1a2.avi");
	...
	VideoWriter output_cap("output1a2.avi", 
	...
	while(1){
	    ...
	    */
	    ...
	    for(int i=0; i<288; i++){
	    	for(int j=0; j<224; j++){
	    		if((int)frame_threshold_init.at<uchar>(i,j) == 255){
	    			//frame.at<Vec3b>(i, j)[0] = 60;
	    			//frame.at<Vec3b>(i, j)[1] = 78;
	    			//frame.at<Vec3b>(i, j)[2] = 115;
		...
		imshow("threshold", frame_threshold_init);
