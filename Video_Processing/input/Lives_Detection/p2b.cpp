...
int trackFilteredObject(Mat threshold){
...
int main(int argc, char* argv[]) {
	...
	VideoCapture input_cap("input2b2.avi");
	...
	VideoWriter output_cap("output2b2.avi", 
	...
	while(1){
        ...
        erode(frame_threshold, frame_threshold, bw_eh);
	    ...
	    */
        ...
        int update_dots = trackFilteredObject(frame_threshold);
        ...
        cout<<max_val<<endl;
        putText(frame,intToString(max_val),Point(60,285),1,1,Scalar(0,255,0),1);
