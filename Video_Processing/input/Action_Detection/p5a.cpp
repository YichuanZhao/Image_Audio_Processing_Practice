...
int main(int argc, char* argv[]) {
	...
	VideoCapture input_cap("input5a2.avi");
	...
	VideoWriter output_cap("output5a2.avi", 
	...
	namedWindow("p1a",0);
	Mat frame, frame_init, frame_threshold_Dots, frame_threhsold_pre, frame_threshold_init, res, HSV, frame_threshold_Pac;
	createTrackbars();
