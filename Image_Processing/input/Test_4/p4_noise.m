...
[I_wr location_white_rock] = find_location(I_use, bw_d, 'white_rock');
[I_wq location_white_queen] = find_location(I_use, bw_d, 'white_queen');
[I_wk location_white_king] = find_location(I_use, bw_d, 'white_king');
...
%moves = bishop_moves([5 8], is_occ_for_white_stones, is_occ_for_black_stones);
%moves = knight_moves([2 6], is_occ_for_white_stones);
